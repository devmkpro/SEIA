    ...
    Route::group(['middleware' => ['school_home']], function () {
        ...
        Route::middleware(['school.role:secretary|director'])->group(function () {
            Route::group(['middleware' => ['school_year_active']], function () {
                ...
                Route::post('/manage/rooms/new', [RoomsController::class, 'store'])->name('manage.rooms.store')->middleware('permission:create-any-room');
                Route::delete('/manage/rooms/delete', [RoomsController::class, 'destroy'])->name('manage.rooms.destroy')->middleware('permission:delete-any-room');
                //Route::update('manage.rooms.update', [RoomsController::class, 'update'])->name('manage.rooms.update');
