            ...
            <form action="{{ route('manage.subjects.store', $curriculum->code) }}" method="POST" id="addSubjectForm">
                ...
                <div class="row ms-2 me-2">
                    <div class="col-md-12 mb-3">
                        ...
                        <select class="form-select" name="name" id="name" value="{{ old('name') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control" name="ch" id="ch"
                                value="{{ old('ch') }}" placeholder="Ex: 200" required>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label for="ch_week" class="form-label">Carga Horária Semanal</label>
                            <input type="number" class="form-control" name="ch_week" id="ch_week"
                                value="{{ old('ch_week') }}" placeholder="Ex: 15" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="3"
                            placeholder="Ex: Disciplina de Matemática" required>{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <select class="form-select" name="modality" id="modality" value="{{ old('modality') }}"
                            required>
        ...
        <script>
            $(document).ready(function() {
                $('#subjectsTable').DataTable({
                    ...
                    "ajax": {
                        "url": "/api/verify/subjects/".concat({{ $curriculum->code }}),
                        "type": "GET",
                        "dataSrc": ""
                    },
                    "columns": [{
