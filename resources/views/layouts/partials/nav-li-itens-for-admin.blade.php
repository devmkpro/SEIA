...
@can('manage-location')
    <li class="nav-item" data-bs-toggle="tooltip" data-bs-title="Serviços de localização" data-bs-placement="right">
...
@can('manage-schools')
    <li class="nav-item" data-bs-toggle="tooltip" data-bs-title="Escolar" data-bs-placement="right">
...
@can('manage-school-years')
    <li class="nav-item" data-bs-toggle="tooltip" data-bs-title="Atribuir/Gerenciar anos letivos" data-bs-placement="right">
