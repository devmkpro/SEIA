    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                <strong>Aviso!</strong> Por padrão a senha será o CPF do professor sem pontos e traços. <br>
                <strong>Exemplo:</strong> CPF: 123.456.789-10 | Senha: 12345678910
                    ...
                    <form action="{{ route('manage.classes.teachers.store', $class->code) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-6 mb-2">
                                ...
                                <input type="date" name="data_nascimento" id="birth_date" class="form-control"
                                    placeholder="Data de nascimento do professor" value="{{ old('data_nascimento') }}"
                                    required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 mb-2">
                                ...
                                <select name="cidade" id="city" class="form-select"
                                    value="{{ old('cidade') }}">
